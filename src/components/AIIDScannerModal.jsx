...
export default function AIIDScannerModal({ isOpen, onClose, onScanComplete }) {
  ...
  return (
    <div className="ai-modal-overlay" onClick={onClose}>
      <div className="ai-modal-card dark-theme-scanner" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 640 }}>
        {/* HEADER MATCHING COMPETITOR VIEWPORT */}
        <div className="ai-modal-head">
          <div className="ai-title-box">
            <h3>🔲 Scan License — Reservation</h3>
            <span>Reads front photo &amp; back PDF417 barcode</span>
          </div>
          <button type="button" className="ai-close-btn" onClick={onClose} aria-label="Close">✕</button>
        </div>

        <div className="ai-modal-body">
          {/* CAMERA SCANNER VIEWFINDER BOX WITH TARGETING FRAME & SWEEP LINE */}
          <div className="camera-viewfinder-container">
            ...
            {/* GLOWING PURPLE TARGETING BOX */}
            <div className="scan-targeting-box">
              <div className="scan-laser-line-sweep"></div>
            </div>
          </div>
          ...
          {/* EXTRACTED BARCODE / OCR RESULTS WITH ALL FIELDS */}
          {scannedData && (
            <div className="ai-extracted-results" style={{ background: "#f8fafc", border: "1.5px solid #cbd5e1", color: "#0f172a", borderRadius: 12, padding: 14, marginTop: 14 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                <h4 className="results-title" style={{ margin: 0, color: "#16a34a", fontSize: "13.5px", fontWeight: 800 }}>
                  {scannedData.isAAMVAValid ? "✅ AAMVA PDF417 Barcode Decoded (100% Accurate)" : "✅ Extracted ID Details & Preview"}
                </h4>
                <button
                  type="button"
                  className="btn btn-sm"
                  style={{ background: "#334155", color: "#ffffff", fontWeight: 800, padding: "6px 14px", border: "1.5px solid #1e293b", borderRadius: 8, cursor: "pointer", fontSize: "12px" }}
                  onClick={handleApply}
                >
              ...
              <div className="results-grid" style={{ display: "flex", gap: 14 }}>
                <div className="photo-box" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
                  <img
                    src={scannedData.photo}
                    alt="Uploaded ID Proof Preview"
                    className="guest-extracted-photo"
                    style={{ width: 84, height: 84, objectFit: "cover", borderRadius: 8, border: "2px solid #16a34a" }}
                  />
                  <span className="photo-label" style={{ color: "#64748b", fontSize: "10px", fontWeight: 700 }}>Document</span>
                </div>

                <div className="fields-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, flex: 1 }}>
                  {/* FIELD 1: FULL NAME */}
                  <div className="result-field">
                    <span className="field-key" style={{ color: "#475569", fontSize: "11px", fontWeight: 700 }}>Full Legal Name:</span>
                    <input
                      type="text"
                      className="form-control form-control-sm"
                      style={{ fontSize: 12, fontWeight: 700, height: 32, padding: "4px 10px", background: "#ffffff", color: "#0f172a", border: "1.5px solid #cbd5e1", borderRadius: 6 }}
                  ...
                  {/* FIELD 2: DRIVER LICENSE NO */}
                  <div className="result-field">
                    <span className="field-key" style={{ color: "#475569", fontSize: "11px", fontWeight: 700 }}>Driver License / ID No:</span>
                    <input
                      type="text"
                      className="form-control form-control-sm"
                      style={{ fontSize: 12, fontWeight: 700, height: 32, padding: "4px 10px", background: "#ffffff", color: "#0f172a", border: "1.5px solid #cbd5e1", borderRadius: 6 }}
                  ...
                  <div className="result-field">
                    <span className="field-key" style={{ color: "#475569", fontSize: "11px", fontWeight: 700 }}>Street Address:</span>
                    <input
                      type="text"
                      className="form-control form-control-sm"
                      style={{ fontSize: 12, fontWeight: 700, height: 32, padding: "4px 10px", background: "#ffffff", color: "#0f172a", border: "1.5px solid #cbd5e1", borderRadius: 6 }}
                  ...
                  <div className="result-field">
                    <span className="field-key" style={{ color: "#475569", fontSize: "11px", fontWeight: 700 }}>City / State / Zip:</span>
                    <input
                      type="text"
                      className="form-control form-control-sm"
                      style={{ fontSize: 12, fontWeight: 700, height: 32, padding: "4px 10px", background: "#ffffff", color: "#0f172a", border: "1.5px solid #cbd5e1", borderRadius: 6 }}
                  ...
                  <div className="result-field">
                    <span className="field-key" style={{ color: "#475569", fontSize: "11px", fontWeight: 700 }}>Date of Birth (DOB):</span>
                    <input
                      type="text"
                      className="form-control form-control-sm"
                      style={{ fontSize: 12, fontWeight: 700, height: 32, padding: "4px 10px", background: "#ffffff", color: "#0f172a", border: "1.5px solid #cbd5e1", borderRadius: 6 }}
                  ...
                  {/* FIELD 6: ID TYPE */}
                  <div className="result-field">
                    <span className="field-key" style={{ color: "#475569", fontSize: "11px", fontWeight: 700 }}>ID Type:</span>
                    <select
                      className="form-control form-control-sm"
                      style={{ fontSize: 12, fontWeight: 700, height: 32, padding: "4px 10px", background: "#ffffff", color: "#0f172a", border: "1.5px solid #cbd5e1", borderRadius: 6 }}
                      value={scannedData.type || "US Driver's License"}
